...
public class SnakeDeadEventTest {
    ...
    public void testSerializationSnakeDeadEvent() throws Exception {
        ...
        TestUtil.populateBaseData(sde, "rPlayerId", "correlationId", "messageId");
        ...
        assertEquals("messageId", parsedSde.getMessageId());
        ...
        assertEquals("rPlayerId", parsedSde.getRecievingPlayerId());
        assertEquals("correlationId", parsedSde.getCorrelationId());
    }
}