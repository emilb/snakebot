...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameControls = __webpack_require__(210);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_GameControls2.default, null)
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewGame = __webpack_require__(231);

	var _NewGame2 = _interopRequireDefault(_NewGame);

	var _MakeMove = __webpack_require__(232);

	var _MakeMove2 = _interopRequireDefault(_MakeMove);

	var _AddPlayer = __webpack_require__(233);

	var _AddPlayer2 = _interopRequireDefault(_AddPlayer);

	var _StartGame = __webpack_require__(234);
	...
	var GameControls = function (_React$Component) {
	    ...
	    function GameControls(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GameControls).call(this, props));
	    ...
	    _createClass(GameControls, [{
	        ...
	        value: function newGame() {
	            (0, _helpers2.default)().then(function (data) {
	                this.setState({
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_NewGame2.default, { newGame: function newGame() {
	                ...
	                _react2.default.createElement(_MakeMove2.default, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function startNewGame() {
	    return _axios2.default.get('http://localhost:8080/newGame').then(function (world) {
	        return { world: world.data };
	    });
	}
	...
	module.exports = function xhrAdapter(resolve, reject, config) {
	  ...
	  request[loadEvent] = function handleReadyState() {
	    if (request && (request.readyState === 4 || xDomain)) {
	      ...
	      (request.status >= 200 && request.status < 300 || xDomain && request.responseText ? resolve : reject)(response);
	  ...
	  if (utils.isStandardBrowserEnv()) {
	    ...
	    // Add xsrf header
	    var xsrfValue = config.withCredentials || isURLSameOrigin(config.url) ? cookies.read(config.xsrfCookieName || defaults.xsrfCookieName) : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewGame = function (_React$Component) {
	    ...
	    function NewGame() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NewGame).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MakeMove = function (_React$Component) {
	    _inherits(MakeMove, _React$Component);

	    function MakeMove() {
	        _classCallCheck(this, MakeMove);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MakeMove).apply(this, arguments));
	    }

	    _createClass(MakeMove, [{
	        key: 'getRef',
	        value: function getRef(direction) {
	        ...
	        value: function handleMakeMove() {
	            ...
	            this.props.world = (0, _helpers2.default)(direction);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddPlayer = function (_React$Component) {
	    ...
	    function AddPlayer() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AddPlayer).apply(this, arguments));
	    }
	    ...
	    _createClass(AddPlayer, [{
	        ...
	        key: 'handleAddPlayer',
	        value: function handleAddPlayer() {
	            var playerName = this.playerName.value;
	            this.playerName.value = '';
	            this.props.player1.id = (0, _helpers2.default)(playerName);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StartGame = function (_React$Component) {
	    ...
	    function StartGame() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(StartGame).apply(this, arguments));
	    }
